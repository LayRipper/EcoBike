...
public class Speedelec extends EcoBike {
    ...
    public Speedelec(String brand, String maxSpeed, String weight, String lightsAvailability,
    ...
    public String toString() {
        return "SPEEDELEC " + getBrand() + "; " + getMaxSpeed() + "; " + getWeight() + "; "
                + isLightsAvailable() + "; " + getBatteryCapacity() + "; " + getColor() + "; "
                + getPrice();
    }
}
